...
@NamedQueries({
    ...
    @NamedQuery(name = "CurvaEsfuerzo.findByIdMaterialRodante", query = "SELECT c FROM CurvaEsfuerzo c WHERE c.curvaEsfuerzoPK.idMaterialRodante = :idMaterialRodante"),
...
public class CurvaEsfuerzo implements Serializable {
    ...
    public String toString() {
        return "entity.CurvaEsfuerzo[ curvaEsfuerzoPK=" + curvaEsfuerzoPK + " ]";
    }
