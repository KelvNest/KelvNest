...
@NamedQueries({
    ...
    @NamedQuery(name = "Restriccion.restriccionEntreEstaciones", query = "SELECT r FROM Restriccion r WHERE r.restriccionPK.idLinea = :idLinea AND :progEstacionInicial < r.progInicio AND r.progFinal < :progEstacionFinal AND r.velocidadMaxAscendente<:vel AND r.velocidadMaxDescendente<:vel"),
...
public class Restriccion implements Serializable {
    ...
    public Restriccion(RestriccionPK restriccionPK, String usuario, double progInicio, double progFinal) {
        this.restriccionPK = restriccionPK;
    ...
    public String toString() {
        return "entity.Restriccion[ restriccionPK=" + restriccionPK + " ]";
    }
