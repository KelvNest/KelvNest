...
@NamedQueries({
    ...
    @NamedQuery(name = "Segmento.findByTunel", query = "SELECT s FROM Segmento s WHERE s.tunel = :tunel"),
...
public class Segmento implements Serializable {
    ...
    public Segmento(SegmentoPK segmentoPK, double pkFinal, boolean recta, double gradiente, boolean tunel) {
        this.segmentoPK = segmentoPK;
    ...
    public boolean getTunel() {
        return tunel;
    }

    public void setTunel(boolean tunel) {
        this.tunel = tunel;
    }
    ...
    public String toString() {
        return "entity.Segmento[ segmentoPK=" + segmentoPK + " ]";
    }
